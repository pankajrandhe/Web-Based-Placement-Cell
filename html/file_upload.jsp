...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
			...
			<ul>
				...
				<li><a href="cs.html">Computer</a></li>
				<li><a href="civil.html">Civil</a></li>
				<li><a href="elpo.html">Electrical</a></li>
				<li><a href="instru.html">Instru</a></li>
				<li><a href="mech.html">Mechanical</a></li>
				<li><a href="exct.html">Extc</a></li>
			</ul>
			</li>
	...
	<div id="three-columns">
		...
		%>	
			<h2>Welcome <%=fname%>&nbsp;<%=lname%></h2></br></br></br></br></br>
			Select a file to upload: <br />
			Note: Your resume must be in .pdf format.<br />
			<form action="../jsp/upload.jsp" method="post" enctype="multipart/form-data">
