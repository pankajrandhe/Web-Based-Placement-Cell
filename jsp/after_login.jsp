...
<h2>Welcome <%=fname%>&nbsp;<%=lname%></h2></br></br></br></br></br>
		<h1><a href="../html/file_upload.jsp" class="link-style">Upload Your Resume</a></h1></br>
		<h1><a href="../jsp/notifications.jsp" class="link-style">Placement Notifications</a></h1></br>
