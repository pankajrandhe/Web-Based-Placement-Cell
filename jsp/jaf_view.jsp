		...
		<div class="content">
			...
			%>
					...
					<table id="tstyle">
							...
							<td colspan="3"><a href='http://<%=rs.getString("company_website")%>'><%=rs.getString("company_website")%></td>
							</tr>
							<tr>
							...
							<td colspan="3"><%=rs.getString("discplines")%></td></td>
							</tr>
							<tr>
							...
							<tr>
							<td>CGPA Criteria</td>
							<td colspan="3"><%=rs.getDouble("criteria")%></td></td>
							</tr>
							<tr>
							...
							<tr>
							<td>Contact No</td>
							<td colspan="3"><%=rs.getLong("contact_no")%></td></td>
							</tr>
							<tr>
							<td>E mail</td>
							<td colspan="3"><%=rs.getString("email")%></td></td>
							</tr>
							<tr>
							<td>Fax</td>
							<td colspan="3"><%=rs.getLong("fax")%></td></td>
							</tr>
							<tr>
					...
					<center>
					<a href="http://localhost:8080/project/jsp/sanction_jaf.jsp"><input type="submit" value="Sanction JAF"></a>
					<a href="http://localhost:8080/project/jsp/decline_jaf.jsp"><input type="submit" value="Decline JAF"></a>
					</center>
					<%
					}
					st.close();
